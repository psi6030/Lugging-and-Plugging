...
// Add outlets to boxes. they don't do anything yet. 

// Make a proper render function for the boxes so they can be redrawn at will
...
function Editor( el ) {
  ...
  this.init = function() {
    ...
    this.boxes = new Boxes({panel: this.ui.panel});
...
var Box = function (opts) {
  ...
  this.render = function() {
    // clearing this out here because sooner or later, render will
    // redraw all the outlets
    self.ui.outlets.html('');
    // add an unconnected outlet
    $('<li />').appendTo(self.ui.outlets);
  }
  ...
  // containers of inlets and outlets
  this.ui.inlets = $('<ul class="inlets" />').appendTo(self.el);
  this.ui.outlets = $('<ul class="outlets" />').appendTo(self.el);
