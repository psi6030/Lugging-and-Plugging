...
// allow inlets to be removed by dragging off their box on to the
// panel -- inlet draggable. outlet droppable. src_cid is in inlet rel
  ...
  this.init = function() {
    ...
    self.ui.panel.droppable({ 
      ...
      drop: function(event, ui) {
        ...
        // if an outlet was dropped, disconnect the boxes. the source
        // box is stored in the rel attr of the inlet to save an
        // expensive search for it.
